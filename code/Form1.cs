...
namespace minigames
{
    public partial class Form1 : Form
    {
        ...
        private void Hide_panel_VisibleChanged(object sender, EventArgs e)
        {
            ...
            if (!hide_panel.Visible)
            {
                ...
                if (MainMenu.Language)
                {
                    ...
                    if (accurate_num != 0)
                        accurate.Text = "Точность " + accurate_num.ToString("0.#") + "px";
                    else
                        accurate.Text = "Идеальная точность";
                }
                else
                {
                    lose_text.Text = "You have lost " + Convert.ToString(lose) + " times";
                    games_text.Text = "Winning " + percent.ToString("0.#") + "%";
                    if (accurate_num != 0)
                        accurate.Text = "Accuracy " + accurate_num.ToString("0.#") + "px";
                    else
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            {
                Text = "EyeStop";
                lose_text.Text = "You have lost 0 times";
                games_text.Text = "Winning 0%";
                accurate.Text = "Accuracy 0px";
            }
            else
